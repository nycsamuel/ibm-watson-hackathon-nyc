...
app.post("/webhook_callback", function(req, res) {
  ...
  // if (annotationType === 'message-nlp-keywords') {
  //   console.log('**** INSIDE ****')
    
  //   var keywords = annotationPayload.keywords;
  //   var searchTerms = keywords.map(function(obj) {
  //     return obj.text;
  //   })
    
  //   console.log('*** search terms *** ', searchTerms);
  //   var queryTerms = searchTerms.join('+');
  //   var GIPHY_API_URL = `http://api.giphy.com/v1/gifs/search?q=${queryTerms}&api_key=dc6zaTOxFJmzC`;
    
  //   // request(GIPHY_API_URL)
  //   // .then(r => r.json())
  //   // .then(data => {
  ...
  if (annotationType === "message-nlp-docSentiment") {
    ...
    var GIPHY_URL = 'http://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC';
    var QUOTES_URL = 'http://quotesondesign.com/api/3.0/api-3.0.json';
